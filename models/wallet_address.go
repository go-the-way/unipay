...
type (
	...
	UnipayWalletAddress struct {
		...
		Address     string `gorm:"column:address;type:varchar(100);not null;default:'';comment:钱包地址;" json:"address"`                // 钱包地址
		Protocol    string `gorm:"column:protocol;type:varchar(10);not null;default:'trc20';comment:协议 trc20/erc20" json:"protocol"` // 协议 trc20/erc20
