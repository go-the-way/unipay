...
type (
	...
	UnipayOrder struct {
		...
		BusinessId     string `gorm:"column:business_id;type:varchar(50);not null;default:'';comment:业务id;index" json:"business_id"`        // 业务id
		...
		PayChannelName string `gorm:"column:pay_channel_name;type:varchar(200);not null;default:'';comment:支付通道名称" json:"pay_channel_name"` // 支付通道名称
