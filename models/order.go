...
type (
	...
	UnipayOrder struct {
		...
		PayPageUrl     string `gorm:"column:pay_page_url;type:varchar(1000);not null;default:'';comment:支付页面Url" json:"pay_page_url"`                                 // 支付页面Url
		PayQrUrl       string `gorm:"column:pay_qr_url;type:varchar(1000);not null;default:'';comment:支付二维码Url" json:"pay_qr_url"`                                    // 支付二维码Url
