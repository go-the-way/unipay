...
type (
	...
	UnipayChannelParam struct {
		...
		ChannelId uint   `gorm:"column:channel_id;type:uint;not null;default:0;comment:支付通道Id;index" json:"channel_id"` // 支付通道Id
		Name      string `gorm:"column:name;type:varchar(200);not null;default:'';comment:参数名称;unique" json:"name"`     // 参数名称
